...
test locally to ensure your code doesn't need twitter_utils included.
...
- Removed trailing ?> from tmhOAuth.php and twitter_utils.php to meet the Zend Framework's coding practices. Props: reedy
...
- Updated twitter_utils::entify with support for media
- Updated twitter_utils::entify with support for multibyte characters. Props: andersonshatch
...
### 0.5 - 29 March 2011
- Moved utility functions out of the main class and into the twitter_utils class.
